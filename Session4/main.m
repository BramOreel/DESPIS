...
% QAM modulation
qamStream = qam_mod(bitStream, M); %wat eruit komt is iets van: length(bitStream)/n (idg 19200), length(qamStream) = aantal substreams in het frequentiedomein

% OFDM modulation
N = 32; %aantal samples die je neemt voor een ifft
Lcp = 16;
...
%function [ data_seq, CHANNELS ] = ofdm_demod(OFDM_seq,N,Lcp,varargin, streamLength,channel,ON_OFF_mask,equalization )
